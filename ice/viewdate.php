...
<link href='//fonts.googleapis.com/css?family=Lato:100,200,300,400,500,600,700,800,900' rel='stylesheet' type='text/css'>
    ...
    <div class="container" style="width:1359px; position: relative; bottom:70px; margin-left: -330px;">
            ...
            <div class="row vertical-offset" style="width: 251%;">
                ...
                <div class="panel panel-default" >
                    <div class="panel-heading" style="height: 34px;">
                        ...
                        <h3 class="panel-title"><b>VIEW DAY TABLE</b></h3>
                    </div>
...
// function to connect and execute the query
                            ...
                            if (isset($_POST['search1'])) {
                                ...
                                // search in all table columns
                                // using concat mysql function
                                $query1 = "SELECT t.id, t.date, t.transfer_type, t.request_time, t.no_of_pax, t.no_of_days, t.flight_time, t.flight_no, t.package_rate, t.package_type, t.start_date, t.end_date, t.pick_up_location, t.drop_location, t.vechicle_id, t.amount, t.payment_method, t.driver, t.ro, t.remark, t.passenger, t.client_id, t.vechicle_id , t.select_option , c.client, c.tel, v.vechicle_type  FROM tour t JOIN client c on c.id = t.client_id JOIN vechicle v on v.id = t.vechicle_id  WHERE `tel`  LIKE '%" . $value . "%' AND DATE(t.date) = DATE(CURDATE()) ORDER BY t.request_time ASC";
...
//           
//       
//             $results = mysqli_query($con, "SELECT t.id, t.pick_date, t.drop_date, t.tour_date, t.request_time, t.no_of_pax, t.no_of_days, t.flight_time, t.flight_no, t.package_rate, t.package_type, t.start_date, t.end_date, t.pick_up_location, t.drop_location, t.vechicle_type, t.amount, t.payment_method, t.driver_id, t.ro_id, t.remark, t.passenger, t.client_id, c.client, d.driver, r.ro FROM tours t JOIN client c on c.client_id = t.client_id JOIN driver d on d.driver_id = t.driver_id JOIN ro r on r.ro_id = t.ro_id ORDER BY t.request_time ASC");
//             
//           }

                            $result = mysqli_query($con, "SELECT t.id, t.date, t.transfer_type, t.request_time, t.no_of_pax, t.no_of_days, t.flight_time, t.flight_no, t.package_rate, t.package_type, t.start_date, t.end_date, t.pick_up_location, t.drop_location, t.vechicle_id, t.amount, t.payment_method, t.driver, t.ro, t.remark, t.passenger, t.client_id, t.vechicle_id , t.select_option , c.client, c.tel, v.vechicle_type  FROM tour t JOIN client c on c.id = t.client_id JOIN vechicle v on v.id = t.vechicle_id  WHERE DATE(t.date) = DATE(CURDATE()) ORDER BY t.request_time ASC LIMIT $start, $limit");
                            ?>                 
...
// $sql = ;
                                ...
                                if (isset($_POST['search'])) {
                                    ...
                                    while ($record = mysqli_fetch_array($search_result)) {
                                        ...
                                        <tr data-toggle="collapse" data-target="#accordion_<?php echo $record['id']; ?>" class="clickable" style="background-color: <?php if ($record['select_option'] == "Dispatched") { ?>#4dff4d;<?php } else if ($record['select_option'] == "Pending") { ?>#FFFFFF<?php } else if ($record['select_option'] == "Cancel") { ?>#FF0000<?php } ?>">                   
                                            ...
                                            echo"<td>";
                                            echo'<form id="form' . $i . '" action="sub2.php" method="post" style="height: 1px;">
                ...
                <input type="submit" value="save" style="position: relative; bottom: 10px;"/>
                                            ...
                                            echo"</td>";
                                            echo"<td><a href=\"edit4.php?id=" . $record['id'] . "\">Edit</a></td>";
                ...
                <input type="submit" value="save" style="position: relative; bottom: 10px;"/>
                                      ...
                                      ?>
                                        ...
                                        <?php
                                    echo "</ul>";
                                    echo '<a class="btn btn-lg btn-success btn-block tp" href="view.php" style="margin-left: 776px; bottom: 7px; position: relative;" onclick="history.back();">Back</a>';
