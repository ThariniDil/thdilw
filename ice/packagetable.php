            ...
            <div class="row vertical-offset" style="width: 251%;">
                ...
                <div class="panel panel-default" >
                    <div class="panel-heading" style="height: 34px;">
                        ...
                        <h3 class="panel-title"><b> PACKAGE DETAILS TABLE</b></h3>
                    </div>
                    <div class="panel-body">
                           ...
                           <?php
                            ...
                            $sql = "SELECT p.id, p.vechicle_id, p.duration, p.mileadge, p.price, p.additional_hour, p.rate_per_km, p.usage_limit, v.vechicle_type FROM packagetype p JOIN vechicle v on v.id = p.vechicle_id ";
...
//           }
                            ...
                            $result = mysqli_query($con, "SELECT p.id, p.vechicle_id, p.duration, p.mileadge, p.price, p.additional_hour, p.rate_per_km, p.usage_limit, v.vechicle_type FROM packagetype p JOIN vechicle v on v.id = p.vechicle_id LIMIT $start, $limit");
                            ?>                 
                            ...
                            <table cellpadding="0" cellspacing="0" border="1" id="table" class="table table-striped table-hover" style="white-space: nowrap;">
                                <thead>
                                    <tr>
                                        <th style="font-weight: bold; width: 1%; text-align: center;">Package ID</th>
                                        <th style="font-weight: bold; width: 1%; text-align: center;">Vechicle Type</th>
                                        <th style="font-weight: bold; width: 1%; text-align: center;">Duration</th>
                                        <th style="font-weight: bold; width: 1%; text-align: center;">Mileage</th>
                                        <th style="font-weight: bold; width: 1%; text-align: center;">Price</th>
                                        <th style="font-weight: bold; width: 1%; text-align: center;">RatePerKm</th>
                                        <th style="font-weight: bold; width: 3%; text-align: center;">Additional Hour</th>
                                        <th style="font-weight: bold; width: 1%; text-align: center;">Usage Limit</th>
...
while ($record = mysqli_fetch_array($result)) {
    ...
    echo"<td style='text-align : center;'>" . $record['vechicle_type'] . "</td>";
    echo"<td style='text-align : center;'>" . $record['duration'] . "Hrs</td>";
    echo"<td style='text-align : center;'>" . $record['mileadge'] . "KM</td>";
    echo"<td style='text-align : center;'> LKR " . $record['price'] . ".00</td>";
    echo"<td style='text-align : center;'> LKR " . $record['rate_per_km'] . ".00</td>";
    echo"<td style='text-align : center;'> LKR " . $record['additional_hour'] . ".00</td>";
    echo"<td style='text-align : center;'>" . $record['usage_limit'] . "</td>";
