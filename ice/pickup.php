...
<link href='//fonts.googleapis.com/css?family=Lato:100,200,300,400,500,600,700,800,900' rel='stylesheet' type='text/css'>
    ...
    <div class="container" style="width:905px; position: relative; bottom:70px; margin-left: -14px;">
            ...
            <div class="row vertical-offset" style="width: 251%;">
                ...
                <div class="panel panel-default" >
                    <div class="panel-heading" style="height: 34px;">
                        ...
                        <h3 class="panel-title">Travel Type: <b>AIRPORT PICKUP/DROP</b></h3>
                    </div>
  ...
  <form id="form" action="post.php" method="post">
                                          ...
                                          <div class="form-group style-3 " style=" bottom: 10px; position: relative;">
...
while ($row = mysqli_fetch_array($result)) {
    ?>
                            ...
                            <div class="form-group style-3 " style="margin-bottom: 4px; margin-left: 323px; bottom: 89px; position: relative; ">
                                <label>Passenger:</label><br />
                                <input type="text" name="passengername" style="height: 30px;" required/>
                            </div>
                            <div class="form-group style-3 " style=" bottom: 81px; position: relative; margin-left: 324px; ">
                            ...
                            <div class="form-group style-3" style="  bottom: 153px; position: relative; ">
                            ...
                            <div class="form-group style-3 " style="bottom: 199px; position: relative;">
                            ...
                            <div class="form-group style-3 " style="bottom: 404px; position: relative;" >
                            ...
                            <div class="form group" style="bottom: 392px; position: relative;">
                                Payment Method:
                                <div>
                            ...
                            <div class="form-group style-3 " style="bottom: 572px; position: relative; margin-left: 330px;">	
...
while ($row = mysqli_fetch_array($result)) {
    ?>
                            ...
                            <div class="form-group style-3 " style=" margin-left: 334px; bottom: 569px; position: relative;">

                                Driver: <br/> <input type="text" name="driver" value="" required/>

                            </div>
                            <div class="form-group style-3 " style="margin-bottom: 4px; margin-left: 4px; bottom: 563px; position: relative;">
                                Remark: <br /><textarea id="txt" name="remark" cols="35" style="height: 80px;" rows="10" required></textarea>
                            </div>

                            <input class="btn btn-lg btn-success btn-block" name="submit" type="submit" value="submit" style="width: 100px; margin-left: 507px; bottom: 574px; position: relative;">
