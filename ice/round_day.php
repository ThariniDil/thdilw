            ...
            <div class="row vertical-offset" style="width: 251%;">
                ...
                <div class="panel panel-default" >
                    <div class="panel-heading" style="height: 34px;">
                        ...
                        <h3 class="panel-title">Travel Type: <b>AIRPORT ROUND DAY</b></h3>
                    </div>
                    <div class="panel-body">


     <form id="form" action="post2.php" method="post">
...
//$sql = "SELECT * FROM passenger";
                            ...
                            <div class="form-group style-3 " style="margin-bottom: 4px; margin-left: 333px; bottom: 92px; position: relative; ">
                                <label>Passenger:</label><br />
                                <input type="text" name="passengername" style="height: 30px;" required/>
                            </div>
                            <div class="form-group style-3 " style=" bottom: 88px; position: relative; margin-left: 333px; ">
                          ...
                          <div class="form-group style-3 " style="bottom: 220px; position: relative;">
                                Start Date: <br /> <input type="text" id="datepicker1" name="startdate" style="height: 30px;" required/>
                            </div>
                            <div class="form-group style-3 " style="margin-bottom: 4px; margin-left: 333px; bottom: 290px; position: relative;">
                                End Date: <br /> <input type="text" id="datepicker2" name="enddate" style="height: 30px;" required/>
                            </div>
                            ...
                            <div class="form group" style="bottom: 394px; position: relative;">
                                Payment Method:
                            <div>
...
//$sql = "SELECT * FROM passenger";
                            ...
                            <div class="form-group style-3 " style="margin-bottom: 4px; margin-left: 4px; bottom: 561px; position: relative;">
